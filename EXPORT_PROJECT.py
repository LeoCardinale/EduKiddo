...
def should_ignore_file(file_path):
    ...
    ignore_files = ['package-lock.json', 'README.md', 'EXPORT_PROJECT.py', 'source_code.txt', 'settings.py', '0001_initial.py', 'webpack-runtime.js', 'demo.js']
...
ignore_dirs = ['node_modules', 'dist', 'build', 'out', '.git', '__pycache__', '.next', 'venv']
